...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r minio
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r minio -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-minio
cd docker-minio
...
You can point your browser to: *`http://Instance's Internet IP:9000`*  
...
| --- | --- | --- | --- |
| Minio-Server | 9000 | Minio API | Y |
| Minio-Console | 9001 | Minio Console | Y |
## Documentation

[Minio Administrator Guide](https://support.websoft9.com/docs/minio)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Minio Enterprise Support](https://apps.websoft9.com/minio) 
