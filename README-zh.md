...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Minio 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://hub.docker.com/r/minio/minio)）：
...
启动应用后，本地浏览器访问 URL: *`http://服务器公网IP:9000`* 进入应用。  
...
| Minio-Console | 9001 | Minio 控制台 | Y |
## 文档

[Minio 管理员手册](https://support.websoft9.com/docs/minio)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Minio 企业级支持版](https://apps.websoft9.com/minio) 
